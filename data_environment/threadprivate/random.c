...
// Without this pragma the linker throws an error:
// /usr/bin/ld: random_last: TLS reference in pi_mc.o mismatches non-TLS definition in random.o section .bss
// TLS: Thread Local Storage.
// It seems that you need to make the variable as threadprivate in every file.
